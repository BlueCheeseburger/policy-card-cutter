...
/**
 * The Warroom-family mark — the same three stripes as Warroom's and
 * policy-flow's, because all three are the same family of tool.
 *
 ...
 * no squircle behind it. Warroom's app icon wraps those stripes in a neon
 * bloom and a grain filter; both are omitted here on purpose — at 18px in a
 * top bar a Gaussian bloom smears the three stripes into one lilac blob.
 */
